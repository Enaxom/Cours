	...
	public static void main (String args[]) throws Exception {
		...
		Action chercher = new Action() {
				public void executer(StringTokenizer st) throws Exception {
					...
					try {
						Individu found = carnet.chercher(nom);
						System.out.println("Individu trouvé:");
						System.out.println("   Nom: " + found.nom());
						System.out.println("   Age: " + found.age());
					} catch (IndividuInexistant e) {
						System.out.println("Individu inexistant: " + nom);
					}
		...
		Action get = new Action() {
				public void executer(StringTokenizer st) throws Exception {
					...
					try {
						Individu found = carnet.get(ind);
						System.out.println("Individu trouvé:");
						System.out.println("   Nom: " + found.nom());
						System.out.println("   Age: " + found.age());
					} catch (IndividuInexistant e) {
						System.out.println("Individu inexistant: " + ind);
					}
				}};
		actions.put("g",get);
		actions.put("get",get);
		...
		Action getall = new Action() {
				public void executer(StringTokenizer st) throws Exception {
					...
					for (Individu ind: individus) {
						...
						System.out.println("   Age: " + ind.age() + "\n");
					}
				}};
		...
		Action feter = new Action() {
				public void executer(StringTokenizer st) throws Exception {
					...
					try {
						Individu found = carnet.chercher(nom);
						found.feter_anniversaire();

						System.out.println("Individu trouvé:");
						System.out.println("L'individu " + found.nom() + " a maintenant " + found.age() + " ans.\nBon anniversaire !");
					} catch (IndividuInexistant e) {
						System.out.println("Individu inexistant: " + nom);
					}
				}};
		...
		Action callback = new Action() {
				public void executer(StringTokenizer st) throws Exception {
					carnet.addCallbackOnCreation(new CallbackOnCreationImpl());
				}};
