...
cd trace_Response
perl response.pl ../out_md1.tr 1 > response.out      #calcul tr instantane
...
cd trace_Length
perl length.pl ../out_md1.tr 1 > length.out
#Affichage entete (pour decrire les champs resultats)
...
./trace_Length/plot.sh $duration "M/D/1"
./trace_Response/plot.sh $duration "M/D/1"
