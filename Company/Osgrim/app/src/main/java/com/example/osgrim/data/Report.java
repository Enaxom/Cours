...
public class Report {
	...
	private Map<ServiceCat, List<Service>> services;
	...
	public Map<ServiceCat, List<Service>> getServices() {
		return services;
	}

	public void setServices(Map<ServiceCat, List<Service>> services) {
	...
	public JSONObject getJSONReport() throws JSONException {
		...
		for (Map.Entry<ServiceCat, List<Service>> entry : services.entrySet()) {
			ServiceCat serviceCat = entry.getKey();
			List<Service> serviceList = entry.getValue();

			JSONObject serviceObj = new JSONObject();
			serviceObj.put("idServiceCat", serviceCat.getId());
